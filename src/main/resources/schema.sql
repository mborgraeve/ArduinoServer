...
drop table INSTRUCTION if exists;
create table INSTRUCTION (id INT primary key auto_increment, instructedTemperature float DEFAULT 10.0, defaultTemperature float DEFAULT 10.0, timeLimit timestamp DEFAULT sysdate, cycleDuration int DEFAULT 60);